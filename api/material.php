...
// Fetch all supplier items for the picker (same as quotation.php)
$result   = $db->getAll('');
...
<head>
    ...
    <!-- Export libraries (same as quotation.php) -->
...
/* Item image inside preview table */
.pv-item-img {
    width: 70px;
    height: 55px;
    object-fit: contain;
    ...
    <div class="qb-layout">
        ...
        <div class="form-panel">
            ...
            <div class="fp-card">
                ...
                <button class="btn-xl-load" onclick="clearAll()" style="border-style:dashed;">
...
// Map: rowId → base64 image string (or null)
const rowImages  = {};
...
function handleImageUpload(id, input) {
    ...
    reader.onload = function (e) {
        rowImages[id] = e.target.result; // base64 string
...
function renderPreview() {
    ...
    // Table rows — each item has an image column
...
function exportExcel() {
    ...
    const data = [
        ...
        [`Ref. No: ${refNo}`],
        [],
        ['Date:',         fmtDate(v('icDate')), '', 'Project Name:', projectName],
        ['Prepared By:',  preparedBy,           '', 'Location:',     projectLoc],
        [],
        ...
        [],
        ...(note ? [['Remarks:', note], []] : []),
        ['Prepared By:', preparedBy, '', 'Approved By:', ''],
    ];
